...
VL53L0X_Error VL53L0X_WriteMulti(VL53L0X_DEV Dev, uint8_t index, uint8_t *pdata, uint32_t count)
{
    ...
    //ESP_LOGW(TAG, "VL53L0X_WriteMulti %02x", Dev->i2c_address);
    ...
    i2c_master_stop(cmd);
    esp_err_t ret = i2c_master_cmd_begin(Dev->i2c_port_num, cmd, I2C_TIMEOUT / portTICK_RATE_MS);
...
VL53L0X_Error VL53L0X_ReadMulti(VL53L0X_DEV Dev, uint8_t index, uint8_t *pdata, uint32_t count)
{
    ...
    //ESP_LOGW(TAG, "VL53L0X_ReadMulti %02x", Dev->i2c_address);
...
{
    VL53L0X_Error err = VL53L0X_WriteMulti(Dev, index, &data, 1);
    if(err != VL53L0X_ERROR_NONE) ESP_LOGW("X", "VL53L0X_WrByte %d", err);
    return err;
}
...
{
    VL53L0X_Error err = VL53L0X_ReadMulti(Dev, index, data, 1);
    if(err != VL53L0X_ERROR_NONE) ESP_LOGW("X", "VL53L0X_RdByte %d", err);
    return err;
}

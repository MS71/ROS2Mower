...
public:
  ...
  bool init(uint8_t devaddr = VL53L0X_I2C_ADDRESS_DEFAULT) {
    ...
    if( devaddr != VL53L0X_I2C_ADDRESS_DEFAULT )
    {
        VL53L0X_SetDeviceAddress(&vl53l0x_dev,devaddr<<1);
        vl53l0x_dev.i2c_address = devaddr;
    }
  ...
  void clearInterrupt() {
    // clear interrupt
    VL53L0X_ClearInterruptMask(&vl53l0x_dev, 0xff);
  }
